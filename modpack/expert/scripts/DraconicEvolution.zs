...
recipes.addShaped(<DraconicEvolution:wyvernHelm>, [[<DraconicEvolution:wyvernCore>, <ore:oreDiamond>, <DraconicEvolution:wyvernCore>], [<ThermalFoundation:material:516>, <IC2:itemArmorQuantumHelmet:27>, <ThermalFoundation:material:516>], [<DraconicEvolution:draconium>, <DraconicEvolution:draconiumEnergyCore>, <DraconicEvolution:draconium>]]);
recipes.addShaped(<DraconicEvolution:wyvernChest>, [[<DraconicEvolution:wyvernCore>, <ore:oreDiamond>, <DraconicEvolution:wyvernCore>], [<ThermalFoundation:material:516>, <IC2:itemArmorQuantumChestplate:27>, <ThermalFoundation:material:516>], [<DraconicEvolution:draconium>, <DraconicEvolution:draconiumEnergyCore>, <DraconicEvolution:draconium>]]);
recipes.addShaped(<DraconicEvolution:wyvernLeggs>, [[<DraconicEvolution:wyvernCore>, <ore:oreDiamond>, <DraconicEvolution:wyvernCore>], [<ThermalFoundation:material:516>, <IC2:itemArmorQuantumLegs:27>, <ThermalFoundation:material:516>], [<DraconicEvolution:draconium>, <DraconicEvolution:draconiumEnergyCore>, <DraconicEvolution:draconium>]]);
recipes.addShaped(<DraconicEvolution:wyvernBoots>, [[<DraconicEvolution:wyvernCore>, <ore:oreDiamond>, <DraconicEvolution:wyvernCore>], [<ThermalFoundation:material:516>, <IC2:itemArmorQuantumBoots:27>, <ThermalFoundation:material:516>], [<DraconicEvolution:draconium>, <DraconicEvolution:draconiumEnergyCore>, <DraconicEvolution:draconium>]]);
