...
recipes.addShaped(<Botania:pylon>, [[<ore:nuggetManasteel>, <ore:ingotGold>, <ore:nuggetManasteel>], [<ore:ingotManasteel>, <ore:manaDiamond>, <ore:ingotManasteel>], [<ore:nuggetManasteel>, <ore:ingotGold>, <ore:nuggetManasteel>]]);
...
mods.botania.Lexicon.addCraftingPage("botania.page.aIntro2", "botania.entry.aIntro", 2, [<Botania:alfheimPortal>], [[[<ore:livingwood>, <Thaumcraft:ItemResource:15>, <ore:livingwood>], [<witchery:ingredient:67>, <Botania:storage:1>, <witchery:ingredient:43>], [<ore:livingwood>, <AWWayofTime:masterBloodOrb>, <ore:livingwood>]]]);
...
mods.botania.Lexicon.addCraftingPage("botania.page.pylon1", "botania.entry.pylon", 1, [<Botania:pylon>], [[[<ore:nuggetManasteel>, <ore:ingotGold>, <ore:nuggetManasteel>], [<ore:ingotManasteel>, <ore:manaDiamond>, <ore:ingotManasteel>], [<ore:nuggetManasteel>, <ore:ingotGold>, <ore:nuggetManasteel>]]]);
mods.botania.Lexicon.addCraftingPage("botania.page.aIntro3", "botania.entry.aIntro", 3, [<Botania:pylon:1>], [[[<ore:nuggetTerrasteel>, <ore:gemEmerald>, <ore:nuggetTerrasteel>], [<ore:ingotTerrasteel>, <Botania:pylon>, <ore:ingotTerrasteel>], [<ore:nuggetTerrasteel>, <ore:pearlEnderEye>, <ore:nuggetTerrasteel>]]]);
