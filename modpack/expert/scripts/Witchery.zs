...
recipes.addShaped(<witchery:ingredient:153>, [[<witchery:seedssnowbell>, <ore:manaPetalCyan>, <witchery:seedsartichoke>], [<ore:manaPetalCyan>, <minecraft:potion>, <ore:manaPetalCyan>], [<witchery:seedsmandrake>, <ore:manaPetalCyan>, <witchery:seedsbelladonna>]]);
recipes.addShaped(<witchery:ingredient:153>, [[<witchery:seedsbelladonna>, <ore:manaPetalCyan>, <witchery:seedssnowbell>], [<ore:manaPetalCyan>, <minecraft:potion>, <ore:manaPetalCyan>], [<witchery:seedsartichoke>, <ore:manaPetalCyan>, <witchery:seedsmandrake>]]);
recipes.addShaped(<witchery:ingredient:153>, [[<witchery:seedsmandrake>, <ore:manaPetalCyan>, <witchery:seedsbelladonna>], [<ore:manaPetalCyan>, <minecraft:potion>, <ore:manaPetalCyan>], [<witchery:seedssnowbell>, <ore:manaPetalCyan>, <witchery:seedsartichoke>]]);
